      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.sectionTitle}>
            🛠️ Skills <span style={styles.hint}>(click to select)</span>
          </div>
          <div style={styles.skillsGrid}>
            {skills.map((s) => (
              <div
                ...
                style={{
                  ...styles.skillChip,
                  backgroundColor: selectedSkills.includes(s.id)
                    ? "#1d4ed8"
                    : "#eff6ff",
                  color: selectedSkills.includes(s.id) ? "#fff" : "#1e40af",
                  border: `1.5px solid ${selectedSkills.includes(s.id) ? "#1d4ed8" : "#bfdbfe"}`,
                }}
