    ...
    <Layout>
      <div style={styles.wrapper}>
        ...
        <div style={styles.headerBtns}>
          ...
          <Link to="/apply-leave">
            <button style={styles.applyBtn}>➕ Apply Leave</button>
          </Link>
        </div>
      </div>
            ...
            {leaves.length === 0 ? (
              <tr>
                <td colSpan={8} style={styles.empty}>
                  ...
                  <Link to="/apply-leave" style={{ color: "#1d4ed8" }}>
                    Apply now
                  </Link>
                </td>
              </tr>
              ...
              leaves.map((l, i) => (
                <tr key={l.id} style={styles.tr}>
                  ...
                  <td style={styles.td}>
                    <span style={styles.leaveType}>{l.leave_name}</span>
                  </td>
                  <td style={styles.td}>
                  ...
                  <td style={styles.td}>
                    <span style={styles.daysBadge}>{l.total_days}d</span>
                  </td>
                  <td style={styles.td}>{l.reason}</td>
                  <td style={styles.td}>
                    <span
                      style={{ ...styles.badge, ...getStatusStyle(l.status) }}
                    >
